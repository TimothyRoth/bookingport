            ...
            if ($_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters('woocommerce_checkout_cart_item_visible', true, $cart_item, $cart_item_key)) {
                ...
                <tr class="<?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
                    <td class="product-name">
                        <?php
                        // Get the custom 'pavillon' data from the cart item
                        if (!empty($cart_item['articles_reserved_by_admin'])) {
                            ...
                            foreach ($cart_item['articles_reserved_by_admin'] as $item) {
                                ...
                                $product_name .= $item['street'] . ' ' . $item['housenumber'] . ', ' . $item['number'] . '<br/>';
                            }

                            if ($has_pavillon === true) {
                                $product_name .= 'inkl. Pavillon </br>';
                            }
                            $counter = 0;
                            ...
                            $product_name = $cart_item['street'] . ' ' . $cart_item['housenumber'] . ', ' . $cart_item['number'] . $pavillon;
                        }
